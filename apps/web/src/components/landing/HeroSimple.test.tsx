...
describe('HeroSimple Component', () => {
  it('renders hero content correctly', () => {
    ...
    expect(screen.getByText(/con inteligencia artificial/i)).toBeInTheDocument();
  ...
  it('displays feature highlights', () => {
    ...
    expect(screen.getByText(/rutinas personalizadas/i)).toBeInTheDocument();
    expect(screen.getByText(/seguimiento inteligente/i)).toBeInTheDocument();
    expect(screen.getByText(/integración con apple health/i)).toBeInTheDocument();
  });
  ...
  it('renders call-to-action buttons', () => {
    ...
    const dashboardButton = screen.getByRole('link', { name: /ir al dashboard/i });
