...
export const ENDPOINT_LIMITS: Record<string, RateLimitConfig> = {
  '/api/v1/ai/generate-routine': { requests: 10, window: '1h', prefix: 'ai-routine' },
  '/api/v1/ai/workout-advice': { requests: 30, window: '1h', prefix: 'ai-advice' },
  '/api/v1/payments/create-preference': { requests: 5, window: '10m', prefix: 'payment' },
  '/api/v1/health/sync': { requests: 100, window: '10m', prefix: 'health-sync' },
};
